...
* In the above visualization, I created an interactive map showing the number of stops in each precinct. The darker the blue the more stops occurred within a precinct. For example we can see that in precincts 23 and 75 over 1000 people of Black, Black Hispanic, White, and White Hispanic races were stopped in the years 2017-2019. 
...
* The interactive plot above shows the number of stops in each borough.
...
* The interactive plot above shows the number of stops grouped by race. We see that for most of the precincts Black people were stopped the most in comparison to White or White Hispanic people. 
...
* The table above shows which precincts White and White Hispanic people were stopped more often than Black people. We see that this was the case in only 16 of the 77 precincts. 
...
* NYC police precincts shapefile (2020). Available at
